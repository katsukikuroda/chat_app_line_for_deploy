...
SECRET_KEY = 'django-insecure-=_^h+g-addvn9(w!ed=qv#326!p#92)ai2s0_-+5c)44+n!=xc'
...
#         'NAME': 'postgres',
#         'USER': 'postgres.zjsytrhdbhejdfdirzwl',
#         'PASSWORD': 'avecvous161',
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'main/static'),  # mainアプリのstaticディレクトリ
]
